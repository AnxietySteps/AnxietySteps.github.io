...
function aboutUs(){
    alertify.alert('Credits', "<a href='https://ryan778.github.io'>Ryan Z.</a> - Framework, Code, CSS, the <a href='https://github.com/AnxietySteps/AnxietySteps.github.io/graphs/contributors'>MVP</a> <-- doesn't pour salt into cups (inside joke)<br>Davis D. - Ideas, Code Drafts, and other useful stuff (the nice way of saying \"Don't get a C# coder to write JavaScript\")<br>Rowan S. - Fun Facts and Animator (Animations and Videos)<br>Sam Z. - Icon and Image Design<br>Ian D. - Made Initial Framework, setup accounts<br><br><a target='_blank' href='https://github.com/AnxietySteps/AnxietySteps.github.io/commits/master'>GitHub Page</a>");
}
